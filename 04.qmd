...
### Load packages
For the work in this module, first install and then load the following packages:
...
## Conclusion
In this module we learned some basics about R and how to get a simple dataset into our environment to work with it. In the following modules we will build on these skills to wrangle and analyze data.
...
3. **Build and load a CSV dataset.** Create a small dataset that is higher education related.
    ...
    c. Examine it with the functions we used in the module for inspecting data and describe the output.
