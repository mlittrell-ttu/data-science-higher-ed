...
: Levels of university structure with leadership stakeholders example data and concerns. {#tbl-uni-structure}
...
Applied data science is defined in many ways. Its definition can be dependent on where the term is used.  Generally, it can be thought of as an approach to working with data so that something useful and trustworthy is produced (Shah, 2020). For example, this output could be a helpful understanding to support a data-informed decision, a model to deliver predictions about an outcome of interest, a clarifying visualization, a report, or an intervention program to serve a university rooted in verifiable data science.
...
![The data science pyramid that flows from raw signals to insights to serve stakeholders](images/chp_1_ds-pyramid.png){#fig-data-pyramid width="700px" height="400px" fig-align="center"}
